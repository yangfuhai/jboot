...
public abstract class AbstractSentinelInterceptor {
    ...
    protected Object handleFallback(Invocation inv, SentinelResource annotation, Throwable ex)
            throws Throwable {
    ...
    private Method extractDefaultFallbackMethod(Invocation inv, String defaultFallback,
                                                Class<?>[] locationClass) {
