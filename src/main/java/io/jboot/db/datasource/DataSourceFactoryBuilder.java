...
public class DataSourceFactoryBuilder {
    ...
    private static DataSourceFactoryBuilder me = new DataSourceFactoryBuilder();

    public static DataSourceFactoryBuilder me() {
        return me;
    }
    ...
    public DataSource build(DataSourceConfig config) {
        ...
        // 不启用分库分表的配置
        if (StrUtils.isBlank(shardingConfigYaml)) {
