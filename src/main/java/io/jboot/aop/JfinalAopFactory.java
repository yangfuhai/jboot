...
//				fieldInjectedClass = getMappingClass(field.getType());
//			}
//
...
//	 */
//	@Deprecated
//	public JfinalAopFactory setEnhance(boolean enhance) {
...
//	 */
//	public JfinalAopFactory setSingleton(boolean singleton) {
...
//	 */
//	public JfinalAopFactory setInjectDepth(int injectDepth) {
//		if (injectDepth <= 0) {
...
//	}
//
//	public JfinalAopFactory addSingletonObject(Object singletonObject) {
...
//	}
//
//	public synchronized <T> JfinalAopFactory addMapping(Class<T> from, Class<? extends T> to) {
...
//	}
//
//	public <T> JfinalAopFactory addMapping(Class<T> from, String to) {
//		try {
//			@SuppressWarnings("unchecked")
