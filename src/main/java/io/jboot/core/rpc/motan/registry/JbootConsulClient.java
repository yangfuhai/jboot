...
public class JbootConsulClient extends ConsulClient {
     ...
     */
    public JbootConsulClient(TLSConfig tlsConfig) {
     ...
     * @param tlsConfig TLS configuration
     */
    public JbootConsulClient(String agentHost, TLSConfig tlsConfig) {
     ...
     * @param tlsConfig TLS configuration
     */
    public JbootConsulClient(String agentHost, int agentPort, TLSConfig tlsConfig) {
